            ...
            <div class="card-body">
              ...
              <form action="{{url('/product/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Tiele" name="title" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="Tiele" class="col-sm-2 col-form-label">Categorized</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Tiele" name="category" required>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Tiele" name="price" required>
                  </div>
                </div>
